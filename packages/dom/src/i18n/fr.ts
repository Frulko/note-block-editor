...
export const fr: EditorLabels = {
  ...
  iconNoResult: 'Aucune icône',
  iconRemove: 'Retirer l’icône',
  iconChooseImage: 'Choisir une image',
  iconPasteUrl: 'ou colle une URL, puis Entrée',
  iconImageStored: 'L’image est stockée par l’application et référencée par le document.',
  iconImageInline: 'Sans stockage configuré, l’image est intégrée en base64 dans le document.',
