...
export default class CarnetPlugin extends Plugin {
  ...
  async onload(): Promise<void> {
    ...
    // ponytail: no status-bar count of our own — Obsidian's core « Statistiques »
    // already reads the file and shows one, and two counts side by side is the
    // bug. Bring ours back only if core's ever goes blank in a Carnet note.
    this.syncTheme();
